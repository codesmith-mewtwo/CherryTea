...
charityController.addCharity= (req,res,next) => {
  // Take in charity name, add it to database
  const {charityName} = req.body;

  got('https://api.data.charitynavigator.org/v2/Organizations?app_id=daae8b79&app_key=7638e36419c57be84cfd662e3d089c0e&search=equal%20justice%20initiative', 
